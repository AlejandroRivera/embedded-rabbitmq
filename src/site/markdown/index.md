...
See [Dependency Information](dependency-info.html) for information specific to your build system.

Releases are deployed to [Maven Central repo](http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22io.arivera.oss%22%20AND%20a%3A%22embedded-rabbitmq%22) 
and will also be available in the [Releases](https://github.com/AlejandroRivera/embedded-rabbitmq/releases) Github page.
 ...
 * Star this project
 * Donate money or create a Bounty
